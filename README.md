...
This repository contains the assets required to build the [Kubernetes website and documentation](https://kubernetes.io/). We're glad that you want to contribute! The documentation is continuously updated to provide the best information about Kubernetes.
...
- Follow the [Documentation Style Guide](https://kubernetes.io/docs/contribute/style/style-guide/) for consistent formatting
- Test your changes locally before submitting
- Keep pull requests focused on a single topic to make review easier
- Provide clear commit messages that explain the purpose of your changes
